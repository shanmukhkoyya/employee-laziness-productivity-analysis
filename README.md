...
Power BI dashboard project analyzing employee productivity and workplace laziness using 200 employee activity records.

## 📊 Project Overview

This project analyzes employee activity data to identify productivity patterns and workplace laziness.

The dashboard calculates a Laziness Index and provides HR-focused insights using Power BI and DAX.
...
- Identify the top productive employees
...
- Employee Drillthrough
- Decomposition Tree
- What-If Parameter for reduced break time
